        ...
        <div className='flex flex-col md:flex-row'>
          ...
          loop={true}
            ...
            <p className='text-sm md:text-md text-justify'>
                Hey there! I'm a passionate full-stack developer with experience in the MERN stack, Java programming, and SQL databases. I specialize in building responsive, user-friendly websites using React, Tailwind CSS, HTML, CSS, and JavaScript. I enjoy turning complex problems into clean, efficient code and constantly aim to grow by building real-world projects and learning new technologies.
            </p>
            <br />
            {/* social media icons */}
